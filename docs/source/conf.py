...
# -*- coding: utf-8 -*-
#
# ipypc documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipypc', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipypc.tex', 'ipypc Documentation',
     'Matt McFarland', 'manual'),
]
